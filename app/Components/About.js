      ...
      <div id="about" className="h-fit md:h-[100vh] py-6 flex flex-col items-center">
        ...
        <div className="abt w-[90%] my-10 lg:my-auto flex flex-col md:flex-row items-center justify-center gap-20 h-[80%]">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5, ease: "easeInOut" }}
            whileTap={{scale:1.05,transition: { duration: 0.1, ease: "easeOut" }}} whileHover={{scale:1.05,transition: { duration: 0.1, ease: "easeOut" }}}  className="p-3 rounded-md md:w-[50%] w-[90%] shadow-slate-400 shadow-lg hover:shadow-slate-600 hover:shadow-xl">
